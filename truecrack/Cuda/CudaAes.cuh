 ...
 */
/*
Collection of header files for AES encryption algorithm
- Aes.h
- Aesopt.h
- Aestab.h
*/
...
#if defined( _GPU_ )
#  define DEVICE __constant__ __align__(32)
//__constant__
#else
#  define DEVICE
#endif
...
#define d_1(t,n,b,e)       EXTERN DEVICE ALIGN CONST XP_DIR t n[256]    =   b(e)
#define d_4(t,n,b,e,f,g,h) EXTERN DEVICE ALIGN CONST XP_DIR t n[4][256] = { b(e), b(f), b(g), b(h) }
EXTERN DEVICE ALIGN CONST XP_DIR uint_32t t_dec(r,c)[RC_LENGTH] = rc_data(w0);
#else
#define d_1(t,n,b,e)       EXTERN DEVICE ALIGN CONST XP_DIR t n[256]
#define d_4(t,n,b,e,f,g,h) EXTERN DEVICE ALIGN CONST XP_DIR t n[4][256]
EXTERN DEVICE ALIGN CONST XP_DIR uint_32t t_dec(r,c)[RC_LENGTH];
#endif
